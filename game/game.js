...
// Function to move the tiles up
  ...
  function moveDown() {
    ...
    // Function to combine the tiles in a row
  function combineRow() {
    for (let i =0; i < 15; i++) {
    ...
    // Function to combine the tiles in a column
 ...
 // Function to handle keyboard controls
  ...
  document.addEventListener('keyup', control)
   ...
   // Functions for handling key presses in different directions 
  ...
  function keyDown() {
   ...
   // Function to check for a win by finding the number 2048
...
// Function to check for a game over by checking for zeros on the board
  function checkForGameOver() {
    ...
    if (zeros === 0) {
      ...
      location.href = "../result/lose.html"
      document.removeEventListener('keyup', control)
    }
  }
  ...
  // Function to add colors to the tiles based on their values
  function addColours() {
    for (let i=0; i < squares.length; i++) {
      if (squares[i].innerHTML == 0) squares[i].style.backgroundColor = '#787572'
